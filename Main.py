...
if __name__ == "__main__":
    ...
    for link in links:
        ...
        for _ in range(2):
            fetch_and_save_html(link+"/#1X2;2", sanitized_filename, True,  )
        ...
        for _ in range(2):
            fetch_and_save_html(link+"/#1X2;3", sanitized_filename, True, )
            odds = get_1x2_odds_by_bookmaker(sanitized_filename)
        ...
        for _ in range(2):
            fetch_and_save_html(link+"/#over-under;2;1.50;0", sanitized_filename, True, )
            odds = get_over_under_odds_by_bookmaker(sanitized_filename)
            columns = ['AQ','AR','AS','AT','AU','AV']
            if any(vv for v in odds.values() for vv in v.values()):
        ...
        for _ in range(2):
            fetch_and_save_html(link+"/#over-under;2;2.50;0", sanitized_filename, True, )
            odds = get_over_under_odds_by_bookmaker(sanitized_filename)
            columns = ['AX','AY','AZ','BA','BB','BC']
            if any(vv for v in odds.values() for vv in v.values()):
        ...
        for _ in range(2):
            fetch_and_save_html(link+"/#over-under;2;3.50;0", sanitized_filename, True, )
            odds = get_over_under_odds_by_bookmaker(sanitized_filename)
            columns = ['BE','BF','BG','BH','BI','BJ']
            if any(vv for v in odds.values() for vv in v.values()):
        ...
        for _ in range(2):
            fetch_and_save_html(link+"/#over-under;3;0.50;0", sanitized_filename, True, )
            odds = get_over_under_odds_by_bookmaker(sanitized_filename)
            columns = ['BL','BM','BN','BO','BP','BQ']
            if any(vv for v in odds.values() for vv in v.values()):
        ...
        for _ in range(2):
            fetch_and_save_html(link+"/#over-under;3;1.50;0", sanitized_filename, True, )
            odds = get_over_under_odds_by_bookmaker(sanitized_filename)
            columns = ['BS','BT','BU','BV','BW','BX']
            if any(vv for v in odds.values() for vv in v.values()):
        ...
        for _ in range(2):
            fetch_and_save_html(link+"/#over-under;3;2.50;0", sanitized_filename, True, )
            odds = get_over_under_odds_by_bookmaker(sanitized_filename)
            columns = ['BZ','CA','CB','CC','CD','CE']
            if any(vv for v in odds.values() for vv in v.values()):
        ...
        for _ in range(2):
            fetch_and_save_html(link+"/#bts;2", sanitized_filename, True, )
            odds = get_yes_no_odds_by_bookmaker(sanitized_filename)
            columns = ['DB','DC','DD','DE','DF','DG']
            if any(vv for v in odds.values() for vv in v.values()):
